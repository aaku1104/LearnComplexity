...
@Component({
  selector: 'app-course-details4',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './coursedetails4.component.html'
})
export class CourseDetails4Component implements OnInit {
  courseId: string = '';
  
  // Course data for Data Science
  course = {
    title: 'Data Science & Machine Learning',
    subtitle: 'Master data analysis, machine learning, and AI with Python and real-world projects',
    description: 'Dive into the world of data science and machine learning with this comprehensive course covering Python, statistics, and AI. Learn to analyze data, build predictive models, and deploy machine learning solutions in real-world scenarios.',
    ...
    instructor: {
      ...
      bio: 'PhD in Computer Science with 12+ years of experience in data science, machine learning, and AI research.',
  ...
  enrollCourse(): void {
    console.log('Enrolling in Data Science & Machine Learning course');
  }
