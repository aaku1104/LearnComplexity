...
@Component({
  selector: 'app-course-details5',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './coursedetails5.component.html'
})
export class CourseDetails5Component implements OnInit {
  courseId: string = '';
  
  // Course data for Digital Marketing
  course = {
    title: 'Digital Marketing Mastery',
    subtitle: 'Complete digital marketing strategy from beginner to advanced',
    description: 'Master the art of digital marketing with comprehensive training in SEO, social media, content marketing, PPC, and analytics. Learn industry best practices and create effective marketing campaigns.',
    category: 'Marketing',
    ...
    instructor: {
      ...
      bio: 'Emily is a certified digital marketing specialist with over 10 years of experience helping businesses grow their online presence. She has worked with Fortune 500 companies and startups alike.',
  ...
  enrollCourse(): void {
    console.log('Enrolling in Digital Marketing Mastery course');
  }
